...
#define SC_OSSL_ECDH_SHARED_SECRET_LEN (64)

void TestEcdh(EC_KEY* key1, EC_KEY* key2)
{
    unsigned char sharedSecretBytes1[SC_OSSL_ECDH_SHARED_SECRET_LEN] = { 0 };
    unsigned char sharedSecretBytes2[SC_OSSL_ECDH_SHARED_SECRET_LEN] = { 0 };
    ...
    if( ECDH_compute_key(sharedSecretBytes1, SC_OSSL_ECDH_SHARED_SECRET_LEN, publicKey2, key1, NULL) <= 0 )
    {
    ...
    if( ECDH_compute_key(sharedSecretBytes2, SC_OSSL_ECDH_SHARED_SECRET_LEN, publicKey1, key2, NULL) <= 0 )
    {
        printOpenSSLError("ECDH_compute_key failed\n");
        goto end;
    }

    if (memcmp(sharedSecretBytes1, sharedSecretBytes2, SC_OSSL_ECDH_SHARED_SECRET_LEN) != 0)
    {
...
#define SC_OSSL_DH_SHARED_SECRET_MAX_LEN (512)

void TestDhDlgroup(const BIGNUM* p)
{
    DH* key1 = NULL;
    DH* key2 = NULL;
    unsigned char sharedSecretBytes1[SC_OSSL_DH_SHARED_SECRET_MAX_LEN] = { 0 };
    unsigned char sharedSecretBytes2[SC_OSSL_DH_SHARED_SECRET_MAX_LEN] = { 0 };
    BIGNUM* p1 = NULL;
    BIGNUM* g1 = NULL;
    BIGNUM* p2 = NULL;
    BIGNUM* g2 = NULL;
    ...
    if (memcmp(sharedSecretBytes1, sharedSecretBytes2, SC_OSSL_DH_SHARED_SECRET_MAX_LEN) != 0)
    {
        printf("Shared secrets don't match\n");
        goto end;
    }
